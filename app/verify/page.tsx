      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="text-center mb-8">
          ...
          <div className="mb-8">
            <input
              ...
              className="w-full bg-gray-50 rounded-lg p-6 text-3xl font-bold text-gray-900 tracking-wider text-center border-2 border-gray-200 focus:border-[#14B8A6] focus:outline-none transition-colors"
            />
          </div>
        ...
        <div className="text-center pt-6 border-t border-gray-200">
          <p className="text-xs text-gray-500">
            Secured by Clear Lens Financial
          </p>
        </div>
      </div>
    </div>
